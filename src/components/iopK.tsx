  ...
  const handleFlowStateChange = useCallback((inFlow: boolean) => {
    if (onStateChange) {
      const newState: AutonomicState = {
        inFlow,
        energyLevel: 100, // We'll update this with actual value in future
        hasActivePattern: false, // We'll update this with actual value in future
        learningCount: 0 // We'll update this with actual value in future
      };
