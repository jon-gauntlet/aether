          ...
          <div className="pattern-list">
            {activePatterns.map((pattern: Pattern) => (
              <div 
                ...
                data-ready={pattern.evolution.metrics?.readyToEvolve}
                data-stage={renderEvolutionStage(pattern).toLowerCase()}
              >
                    ...
                    <>
                      <div className="metric">
                        ...
                        <div className="growth-rate">
                          {Math.round(pattern.evolution.metrics.growthRate * 100)}%
                          {pattern.evolution.metrics.readyToEvolve && (
                      ...
                      <div className="metric">
                        ...
                        <div className="usage-count">
                          {pattern.evolution.metrics.usageCount} sessions
                        </div>
                      </div>
                      ...
                      <div className="metric">
                        ...
                        <div className="quality-bar">
                          <div 
                            ...
                            style={{
                              width: `${pattern.evolution.metrics.averageQuality * 100}%`,
                      ...
                      <div className="metric">
                        ...
                        <div className="intensity-bar">
                          <div 
                            ...
                            style={{
                              width: `${pattern.evolution.metrics.averageIntensity * 100}%`,
                      ...
                      <div className="metric">
                        ...
                        <div className="protection-rate">
                          {Math.round(pattern.evolution.metrics.protectionRate * 100)}%
                        </div>
                      </div>
                    </>
                  )}
