...
export const App: React.FC = () => {
  const { flowState, patternMetrics, energyState, currentMode, setMode } = useAutonomicDevelopment();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <FlowModeSelector currentMode={currentMode} onModeChange={setMode} />
        <FlowStateIndicator flowValue={0.80} />
      </Header>
