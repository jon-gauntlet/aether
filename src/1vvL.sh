...
BACKUP_DIR="/home/jon/system_backups/packages"
BACKUP_FILE="$BACKUP_DIR/packages_backup_$(date +%Y%m%d).txt"
...
echo "If you need to restore packages, check $BACKUP_FILE" 