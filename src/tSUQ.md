...
### Trade-offs
- `to prevent lack of knowledge, and to facilitate leveling-up on any of these AppSec skillsets, after doing AI-led problem-solving, set solo study in order to self-quiz to ensure you can actually do the same problem-solving independently`
