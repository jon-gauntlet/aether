...
import { useFlowState, useEnergyAnalytics } from '../../core/hooks';
      ...
      <div className="flow-monitor-content">
        ...
        <div className="flow-analytics">
          ...
          <div className="analytics-item">
            ...
            <div className="analytics-value">
              {(protectionRate * 100).toFixed(1)}%/hr
            </div>
          </div>
        </div>
        ...
        <div className="session-metrics">
          <div className="metrics-header">
            ...
            <span className="session-count">
              {sessionMetrics.totalSessions} sessions today
            </span>
          </div>
          ...
          <div className="metrics-grid">
            <div className="metric-item">
              ...
              <div className="metric-value">
                {Math.round((sessionMetrics.qualityScore ?? 0) * 100)}%
              </div>
            </div>

            <div className="metric-item">
              <span>Protection Efficiency</span>
              <div className="metric-value">
                {Math.round((sessionMetrics.protectionEfficiency ?? 0) * 100)}%
              </div>
            </div>
            ...
            <div className="metric-item">
              ...
              <div className="metric-value">
                {Math.round(sessionMetrics.averageIntensity * 100)}%
              </div>
            </div>
            ...
            <div className="metric-item">
              ...
              <div className="metric-value">
                {sessionMetrics.protectedSessions}/{sessionMetrics.totalSessions}
              </div>
            </div>
          </div>
        </div>
