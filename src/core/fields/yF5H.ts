...
import { FieldSystem, FieldState } from '../fields/FieldSystem';
import { MetricsSystem, SystemMetrics } from '../metrics/MetricsSystem';
...
export class SystemIntegration {
  ...
  public updateConsciousness(consciousness: ConsciousnessState): void {
    this.contextSystem.updateContext(
      ...
      (this.fieldSystem.getFieldState() as BehaviorSubject<FieldState>).getValue().activeField,
      consciousness
    );
    this.checkSystemHealth();
  }
  ...
  private checkSystemHealth(): void {
    const fieldState = (this.fieldSystem.getFieldState() as BehaviorSubject<FieldState>).getValue();
    const protectionState = (this.protectionSystem.getState() as BehaviorSubject<ProtectionState>).getValue();
    const metrics = (this.metricsSystem.getMetrics() as BehaviorSubject<SystemMetrics>).getValue();
