...
preflight_check() {
    ...
    # Keep essential messaging apps and development tools
    KEEP_PKGS="telegram-desktop signal-desktop element-desktop python-pip python-poetry python-virtualenv docker git cmake neovim tmux"
