...
// Extended flow with additional metrics
export interface Flow extends NaturalFlow {
  ...
  // Stream management
  stream?: FlowStream;
  updatePresence(type: string): void;
}

// Wave represents an oscillation in a field
...
// Field represents a resonance field in space
