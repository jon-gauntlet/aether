...
[Service]
Type=simple
ExecStart=/usr/bin/cursor --workspace=/
Slice=claude-instances.slice
Environment=CLAUDE_WORKSPACE=/
CPUWeight=45
IOWeight=45
MemoryHigh=6G
MemoryMax=8G
...
[Service]
Type=simple
ExecStart=/usr/bin/cursor --workspace=/home/jon/projects/aether
Slice=claude-instances.slice
Environment=CLAUDE_WORKSPACE=/home/jon/projects/aether
CPUWeight=45
IOWeight=45
MemoryHigh=6G
MemoryMax=8G
