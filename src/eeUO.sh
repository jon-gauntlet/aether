...
sudo cp "$SCRIPT_DIR/g_command.sh" /usr/local/bin/g
sudo cp "$SCRIPT_DIR/focus-mode-manager" /usr/local/bin/focus-mode-manager
sudo chmod +x /usr/local/bin/g /usr/local/bin/focus-mode-manager

# Install systemd units
sudo cp "$SCRIPT_DIR/gauntlet-dirs.service" /etc/systemd/system/
sudo cp "$SCRIPT_DIR/gauntlet-focus.slice" /etc/systemd/system/
sudo cp "$SCRIPT_DIR/gauntlet-focus.service" /etc/systemd/system/
